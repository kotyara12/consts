...
#define CONFIG_MESSAGE_TG_INET_UNAVAILABLE "📴 Доступ к <b>сети интернет</b> потерян!"
#define CONFIG_MESSAGE_TG_HOST_AVAILABLE "💠 Доступ к <b>серверу</b> <b>%s</b> восстановлен\n\n<code>Время начала проблем: </code><b>%s</b>\n<code>Время восстановления: </code><b>%s</b>\n<code>Проблемы наблюдались: </code><b>%d</b> час <b>%d</b> мин <b>%d</b> сек"
#define CONFIG_MESSAGE_TG_GWAY_AVAILABLE "📶 Доступ к <b>роутеру восстановлен\n\n<code>Время начала проблем: </code><b>%s</b>\n<code>Время восстановления: </code><b>%s</b>\n<code>Проблемы наблюдались: </code><b>%d</b> час <b>%d</b> мин <b>%d</b> сек"
#define CONFIG_MESSAGE_TG_INET_AVAILABLE "🌐 Доступ к <b>сети интернет</b> восстановлен\n\n<code>Время начала проблем: </code><b>%s</b>\n<code>Время восстановления: </code><b>%s</b>\n<code>Проблемы наблюдались: </code><b>%d</b> час <b>%d</b> мин <b>%d</b> сек"
#define CONFIG_MESSAGE_TG_WIFI_AVAILABLE "📶 Подключение к точке доступа WiFi <b>%s</b> восстановлено\n\n<code>Время начала проблем: </code><b>%s</b>\n<code>Время восстановления: </code><b>%s</b>\n<code>Проблемы наблюдались: </code><b>%d</b> час <b>%d</b> мин <b>%d</b> сек"
